#!/usr/bin/env python3
"""
Sample Usage Examples for SPARK Phenotypes

This script demonstrates how to load and work with the SPARK Phenotypes dataset.
...
# Dataset paths
DATASET_DIR = Path('data/raw/SPARK_phenotypes')
DATA_FILE = DATASET_DIR / 'data' / 'SPARK_phenotypes_data.csv'  # Adjust filename as needed
DICT_FILE = Path('data/documentation/data_dictionaries/SPARK_phenotypes_dictionary.json')


def load_dataset():
    """Load the SPARK Phenotypes dataset"""
