#!/usr/bin/env python3
"""
Sample Usage Examples for ABCD Microbiome

This script demonstrates how to load and work with the ABCD Microbiome dataset.
...
# Dataset paths
DATASET_DIR = Path('data/raw/ABCD_microbiome')
DATA_FILE = DATASET_DIR / 'data' / 'ABCD_microbiome_data.csv'  # Adjust filename as needed
DICT_FILE = Path('data/documentation/data_dictionaries/ABCD_microbiome_dictionary.json')


def load_dataset():
    """Load the ABCD Microbiome dataset"""
