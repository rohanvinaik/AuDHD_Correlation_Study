#!/usr/bin/env python3
"""
Sample Usage Examples for PGC ADHD GWAS

This script demonstrates how to load and work with the PGC ADHD GWAS dataset.
...
# Dataset paths
DATASET_DIR = Path('data/raw/PGC_ADHD_GWAS')
DATA_FILE = DATASET_DIR / 'data' / 'PGC_ADHD_GWAS_data.csv'  # Adjust filename as needed
DICT_FILE = Path('data/documentation/data_dictionaries/PGC_ADHD_GWAS_dictionary.json')


def load_dataset():
    """Load the PGC ADHD GWAS dataset"""
